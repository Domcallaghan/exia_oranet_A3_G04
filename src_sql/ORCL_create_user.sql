...
--      Auteur : zae
--      Date de dernière modification : 10/2/2015 10:13:47
-- -----------------------------------------------------------------------------
...
,   CONSTRAINT PK_FOURNISSEUR PRIMARY KEY (FOU_ID)  USING INDEX TABLESPACE INDEX_TBS
   ) ;
...
,   CONSTRAINT PK_MEDICAMENT PRIMARY KEY (MED_NOM, MED_NUM_LOT)  USING INDEX TABLESPACE INDEX_TBS
   ) ;
...
,   CONSTRAINT PK_MEDECIN PRIMARY KEY (MED_ID)  USING INDEX TABLESPACE INDEX_TBS
   ) ;
...
,   CONSTRAINT PK_COMMANDE PRIMARY KEY (COM_ID)  USING INDEX TABLESPACE INDEX_TBS
   ) ;
...
,   CONSTRAINT PK_ALLERGIE PRIMARY KEY (ALL_ELEMENT_ALLERGENE) USING INDEX TABLESPACE INDEX_TBS 
   ) ;
...
,   CONSTRAINT PK_PATIENT PRIMARY KEY (PAT_NUM)  USING INDEX TABLESPACE INDEX_TBS
   ) ;
...
,   CONSTRAINT PK_ETAT PRIMARY KEY (ETAT_ID)  USING INDEX TABLESPACE INDEX_TBS
   ) ;
...
,   CONSTRAINT PK_CENTRE_DE_GESTION PRIMARY KEY (CDG_ID)  USING INDEX TABLESPACE INDEX_TBS
   ) ;
...
,   CONSTRAINT PK_ORDONNANCE PRIMARY KEY (ORD_NUM)  USING INDEX TABLESPACE INDEX_TBS
   ) ;
...
,   CONSTRAINT PK_MUTUEL PRIMARY KEY (MUT_ID)  USING INDEX TABLESPACE INDEX_TBS
   ) ;
...
,   CONSTRAINT PK_CLASSE_PHARMACEUTIQUE PRIMARY KEY (CPH_ID)  USING INDEX TABLESPACE INDEX_TBS
   ) ;
...
,   CONSTRAINT PK_LIGNE_COMMANDE PRIMARY KEY (MED_NOM, MED_NUM_LOT, COM_ID)  USING INDEX TABLESPACE INDEX_TBS
   ) ;
...
CREATE TABLE FOURNIR
   (
    ...
    MED_NUM_LOT CHAR(12)  NOT NULL,
    QTE NUMBER(4)  NOT NULL
,   CONSTRAINT PK_FOURNIR PRIMARY KEY (FOU_ID, MED_NOM, MED_NUM_LOT)  USING INDEX TABLESPACE INDEX_TBS
   ) ;
...
,   CONSTRAINT PK_INCOMPATIBILITER PRIMARY KEY (CPH_ID, CPH_ID_1)  USING INDEX TABLESPACE INDEX_TBS
   ) ;
...
,   CONSTRAINT PK_RATTACHER PRIMARY KEY (PAT_NUM)  USING INDEX TABLESPACE INDEX_TBS
   ) ;
...
CREATE TABLE POSSEDER
   (
    PAT_NUM NUMBER(2)  NOT NULL,
    ALL_ELEMENT_ALLERGENE CHAR(38)  NOT NULL
,   CONSTRAINT PK_POSSEDER PRIMARY KEY (PAT_NUM, ALL_ELEMENT_ALLERGENE) USING INDEX TABLESPACE INDEX_TBS 
   ) ;
