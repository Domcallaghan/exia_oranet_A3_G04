...
CREATE TABLE COMMANDE
   (
    ...
    COM_MTN_TOTALE NUMBER(5)  NOT NULL,
    COM_MTN_PATIENT NUMBER(5)  NOT NULL,
    COM_MTN_SECU NUMBER(5)  NULL,
    COM_MTN_MUTUEL NUMBER(5)  NULL
...
,   CONSTRAINT PK_ALLERGIE PRIMARY KEY (ALL_ID) USING INDEX TABLESPACE PHARMA_NDX
   ) ;
...
CREATE TABLE POSSEDER
   (
    PAT_NUM NUMBER(2)  NOT NULL,
    ALL_ID NUMBER(4)  NOT NULL
,   CONSTRAINT PK_POSSEDER PRIMARY KEY (PAT_NUM, ALL_ID) USING INDEX TABLESPACE PHARMA_NDX 
   ) ;
